...
export default function CreateAssessmentPage() {
  ...
  const [newCodingChallenge, setNewCodingChallenge] = useState<CodingChallenge>({
    title: "",
    description: "",
  ...
  const handleDetailsChange = (field: keyof Assessment, value: any) => {
    ...
    if (field === "skillId") {
      const skill = skills.find(s => s.id === parseInt(value))
      if (skill) {
        setAssessment(prev => ({
          ...prev,
  ...
  const handleChallengeChange = (field: keyof CodingChallenge, value: any) => {
    ...
    <div className="container mx-auto py-8">
      <div className="flex items-center mb-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground">Create a new skill assessment</p>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => handleDetailsChange("skillId", parseInt(value))}
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => handleDetailsChange("difficulty", value as "Beginner" | "Intermediate" | "Advanced")}
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleDetailsChange("passingScore", parseInt(e.target.value))}
                    />
                  </div>
                </div>
              </div>
