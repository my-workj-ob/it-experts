        ...
        <section className="py-20 bg-gradient-to-b from-primary/10 to-background dark:from-primary/5">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <Button size="lg" variant="outline" className="border-primary/30 text-primary hover:bg-primary/5" asChild>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-card rounded-lg p-8 shadow-md border hover:shadow-lg hover:border-primary/30">
                ...
                <h3 className="text-xl font-semibold mb-3">AI-Powered Matchmaking</h3>
              ...
              <div className="bg-card rounded-lg p-8 shadow-md border hover:shadow-lg hover:border-primary/30">
                ...
                <h3 className="text-xl font-semibold mb-3">Professional Profiles</h3>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div className="bg-card rounded-lg p-8 shadow-md border hover:shadow-lg hover:border-amber-300">
                ...
                <h3 className="text-xl font-semibold mb-3">
                  AI Assistant
                  <Badge className="ml-2 bg-amber-100 text-amber-600 hover:bg-amber-200">PRO</Badge>
                </h3>
                <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="bg-card rounded-lg p-8 shadow-lg border-primary relative transform scale-105">
                <Badge className="absolute -top-3 right-8 px-3 py-1 bg-amber-500 text-white">Popular</Badge>
