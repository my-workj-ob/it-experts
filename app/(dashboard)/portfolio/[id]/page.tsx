...
const getProjectDetails = async (id: string) => {
  ...
  return {
    ...
    description:
      "A complete redesign of an e-commerce platform focusing on user experience and conversion optimization. The project included user research, wireframing, prototyping, and implementation.",
...
The final design features a clean, modern aesthetic with a focus on product imagery, simplified navigation, and a streamlined checkout process. The result was a 35% increase in conversion rate and a 42% increase in average session duration.`,
    ...
    images: [
      JSON.stringify({
        fileUrl: "/placeholder.svg?height=200&width=200&text=Image1",
      }),
      JSON.stringify({
        fileUrl: "/placeholder.svg?height=200&width=200&text=Image2",
      }),
      JSON.stringify({
        fileUrl: "/placeholder.svg?height=200&width=200&text=Image3",
      }),
    ],
    tags: [
      "React",
    ...
    comments: [
      ...
      },
      {
        ...
        content:
          "The UI is very clean and intuitive. How did you handle the product filtering?",
      ...
      },
      {
        ...
        content:
          "This is exactly what I've been looking for as a reference for my own project. Thanks for sharing!",
        ...
        <div className="md:col-span-2">
          <Card>
            <CardContent className="p-0">
              <img
                src={
                  get(JSON.parse(get(project, "imageUrl")), "fileUrl") ||
                  "/placeholder.svg"
                }
                alt={project.title}
            ...
            <Card className="mt-6">
              <CardContent className="p-6">
                <h3 className="font-bold mb-4">
                  More Projects by {project.author}
                </h3>
                <div className="space-y-4">
