      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p
            className={cn(
              "text-sm truncate",
              contact.unread > 0 ? "text-white font-medium" : "text-slate-400"
            )}
          >
        ...
        {contact.unread > 0 && (
          <Badge className="ml-auto bg-green-500 text-white animate-bounce-subtle">
            {contact.unread}
          </Badge>
        )}
        {contact.isBlocked && (
          <Badge
            variant="outline"
            className="ml-auto bg-red-500/10 text-red-400 border-red-500/20"
          >
            Blocked
          </Badge>
        )}
